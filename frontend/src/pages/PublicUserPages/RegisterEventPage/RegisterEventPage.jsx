...
const RegisterEvent = () => {
    ...
    const handleRegisterEvent = async () => {
        ...
        // dataToPost.append('event_id', eventId);
        // dataToPost.append('image', capturedImage);
            ...
            <div className={styles.main_wrap}>
                {
                    ...
                    !eventDetails ?
                        <DotLoader /> :
                        new Date(eventDetails?.registration_end_date).getTime() > new Date().getTime() ?
                            <div className={styles.modal_wrap}>
                                ...
                                <div className={styles.capture_photo}>
                                    {!capturedImage ? (
                                        <>
                                            {isCameraAllowed ? ( // Render camera if access is allowed
                                                <>
                                ...
                                <div className={styles.register_event}>
                                    <button className={styles.register__} onClick={handleRegisterEvent} disabled={!isCameraAllowed}>Register</button>
                                </div>
                            </div> :
