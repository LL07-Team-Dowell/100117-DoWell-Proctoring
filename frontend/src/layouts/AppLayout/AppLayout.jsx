        ...
        <section className={styles.wrapper}>
            <section className={styles.side__Nav}>
                ...
                <ul className={styles.user__Links__Wrap}>
                    {
                        React.Children.toArray(userNavLinks.map(linkItem => {
                            return <li onClick={() => navigate(linkItem.path)}>
                ...
                <div className={styles.user__Info__Wrap}>
                    <div className={styles.user__Info}>
                        ...
                        />
                        <p>{currentUser?.userinfo?.first_name} {currentUser?.userinfo?.last_name}</p>
                    </div>
